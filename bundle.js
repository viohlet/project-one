...
/***/ function(module, exports, __webpack_require__) {
	...
	var hideBoard2 = function hideBoard2() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexGames = function onIndexGames(event) {
		event.preventDefault();
		api.indexGames().done(ui.onIndexGamesSuccess).fail(ui.failure);
	};
	...
	var blockPlay = function blockPlay() {
		$('.tile').off('click');
	};
	...
	var checkForWin = function checkForWin() {
		...
		marker === boardArray[3] && marker === boardArray[4] && marker === boardArray[5] || marker === boardArray[6] && marker === boardArray[7] && marker === boardArray[8] || marker === boardArray[0] && marker === boardArray[3] && marker === boardArray[6] || //vertical
		marker === boardArray[1] && marker === boardArray[4] && marker === boardArray[7] || marker === boardArray[2] && marker === boardArray[5] && marker === boardArray[8] || marker === boardArray[0] && marker === boardArray[4] && marker === boardArray[8] || //diagonal
	...
	var onClickTile = function onClickTile(event) {
		event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(index, value, over1) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexGamesSuccess = function onIndexGamesSuccess(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "14eb856a8e01d5d4f61239f3cdc9af79.jpg";
